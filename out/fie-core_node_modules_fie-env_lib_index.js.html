...
<head>
	...
	<title>共享FIE Source: fie-core/node_modules/fie-env/lib/index.js</title>
...
<div class="row">
	...
	<div class="col-md-12">
		...
		<h1 class="page-title">Source: fie-core/node_modules/fie-env/lib/index.js</h1>
...
const fieNpm = {
  ...
  runInstall : function*( installer, paths, options ){
   ...
   * @param options
   */
  npmInstall: function*(pkg, options) {
    const installer = path.resolve(__dirname, '../node_modules/.bin/npminstall');
    yield fieNpm.runInstall(installer,pkg,options);
  },

	/**
   * 移除npm包
   */
  npmUnInstall : function*(pkg, options) {
  ...
  installDependencies : function*(options) {
    const installer = path.resolve(__dirname, '../node_modules/.bin/npmuninstall');
    yield fieNpm.runInstall(installer,null,options);
  }

};

module.exports = fieNpm;</pre>
    </article>
</section>
